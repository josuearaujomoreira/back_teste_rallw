  ...
  app.withTypeProvider<ZodTypeProvider>().put(
    ...
    async (request, reply) => {
      try {
        ...
        const { name, age, corporationId, instrument } = request.body
        ...
        await prisma.attendee.update({
          ...
          data: {
            name: nameFormatted,
            age:
              age === null || age === undefined ? attendeeResponse?.age : age,
            instrument: instrument ? instrument : attendeeResponse.instrument,
            corporationId:
